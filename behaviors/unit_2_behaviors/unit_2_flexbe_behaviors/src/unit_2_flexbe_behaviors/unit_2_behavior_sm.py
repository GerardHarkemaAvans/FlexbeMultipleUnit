...
'''
class unit_2_behaviorSM(Behavior):
	'''
	Het gedrag van unit 2
	'''


	def __init__(self):
		super(unit_2_behaviorSM, self).__init__()
		self.name = 'unit_2_behavior'
	...
	def create(self):
		...
		with _state_machine:
			# x:213 y:36
			OperatableStateMachine.add('unit_2_dummy',
